...
class Houzez_Nav_Menu extends Widget_Base {

	protected $nav_menu_index = 1;

	public function get_name() {
		return 'houzez-nav-menu';
	}

	public function get_title() {
		return esc_html__( 'Nav Menu Pro', 'elementor-pro' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'default' => 'tablet',
				'options' => array(),//$dropdown_options,
...
Plugin::instance()->widgets_manager->register( new Houzez_Nav_Menu );
